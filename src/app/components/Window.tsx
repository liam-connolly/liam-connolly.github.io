    ...
    return (
      <Draggable handle=".header" bounds="parent" defaultClassName="absolute">
        <div className="window">
          <div className="header bg-navGrey flex-col p-2  border-2 border-t-white border-l-white border-r-grey border-b-grey">
            <div className="flex items-center gap-2 ">
              ...
              />
              <div
                className="bg-darkBlue px-4 border-2 border-t-white border-l-white border-r-black border-b-black"
                style={{ color: "white" }}
              >
                Liam Connolly / ©
              </div>
